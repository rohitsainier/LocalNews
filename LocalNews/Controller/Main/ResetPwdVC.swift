...
class ResetPwdVC: UIViewController {
    ...
    private func Customization() {
        nextBtn.sainiShadowWithGradientAndCornerRadius(shadowColor: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 0.16), shadowOpacity: 1, shadowRadius: 5, cornerRadius: nextBtn.frame.height / 2, colorArr: [#colorLiteral(red: 0.2, green: 0.5764705882, blue: 0.6705882353, alpha: 1), #colorLiteral(red: 0.07058823529, green: 0.4392156863, blue: 0.568627451, alpha: 1)], verticalGradient: false)
